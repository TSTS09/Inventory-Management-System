...
<body>
  <div class="container">
    ...
    <section class="inventory">
      <div class="inventory-list">
        ...
        <button class="add-inventory-btn" id="generate-report" href="../actions/generate_report.php">
          Generate report
        </button>
  ...
  // event listener to the add product button
  addInventorybtn.addEventListener("click", () => {
    modal.style.display = "block";
  });

  // event listener to the close button of add product modal
  closeModalBtn.addEventListener("click", () => {
    modal.style.display = "none";
  });

  // event listener to generate report
